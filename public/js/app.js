...
var adminInit = function adminInit() {
  console.log("hey iniside the admin pannel");
  var ordersBody = document.querySelector("#orderTableBody");
  ...
  var renderItems = function renderItems(items) {
    ...
    return parsedItems.map(function (item) {
      return "<p> ".concat(item.item.name, " - ").concat(item.qty, "</p>   ");
    }).join("");
  }; // generating the markup to render in the client side
...
var adminInit = __webpack_require__(/*! ./admin */ "./resources/js/admin.js"); // querySelectorAll gets all the elem in an array


var addToCart = document.querySelectorAll(".add-to-cart");
var cartCounter = document.getElementById("cart-counter");
var alertElm = document.querySelector("#success-alert");
console.log("alert");
...
function updateCart(product) {
  axios.post("/update-cart", product).then(function (res) {
    var cartCount = res.data.totalQty;
...
addToCart.forEach(function (elem) {
  elem.addEventListener("click", function (e) {
    var product = JSON.parse(elem.dataset.product);
    updateCart(product);
  });
});
adminInit(); //update the order status

var statuses = document.querySelectorAll(".status_line");
var orderElem = document.querySelector("#hiddenInput");
var order = orderElem ? orderElem.value : null;
...
function updateStatus(order) {
  ...
  statuses.forEach(function (stat) {
    var dataStatus = stat.dataset.status;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfoodnity"] = self["webpackChunkfoodnity"] || [];
